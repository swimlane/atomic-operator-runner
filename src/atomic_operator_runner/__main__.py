...
@click.option("--platform", required=True, type=click.Choice(["windows", "macos", "linux"], case_sensitive=False), help="Platform to run commands on.")
...
def main(platform, hostname, username, password, ssh_key_path, private_key_string, verify_ssl, ssh_port, ssh_timeout, command, executor, elevated) -> None:
